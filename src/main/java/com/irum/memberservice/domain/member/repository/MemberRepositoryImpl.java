package com.irum.memberservice.domain.member.repository;

import static com.irum.memberservice.domain.member.domain.entity.QMember.member;

import com.irum.memberservice.domain.member.domain.repository.MemberRepositoryCustom;
